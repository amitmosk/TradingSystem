...
public class SystemStartConfig {
    public static void init_data_to_market(PaymentAdapter paymentAdapter, SupplyAdapter supplyAdapter) {
        ...
        // register
        marketFacade1.register("amitt@gmail.com","12345678aA","amit","moskovitz",birth_date);
        marketFacade2.register("tomt@gmail.com","12345678aA","amit","moskovitz",birth_date);
        marketFacade3.register("galt@gmail.com","12345678aA","amit","moskovitz",birth_date);
        marketFacade4.register("grumett@gmail.com","12345678aA","amit","moskovitz",birth_date);
        marketFacade5.register("eylont@gmail.com","12345678aA","amit","moskovitz",birth_date);
//        // open store
