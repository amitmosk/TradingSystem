...
//            Bid bid = new Bid(1, 5, 20, managers_emails, product, user);
...
//            AssignUser buyer = new AssignUser("owner@walla.com","12345678aA","buyer","buyer");
//            Bid bid = new Bid(1, 5, 20, managers_emails, product, user);
//            bid.add_manager_answer("founder@walla.com", false, -1);
...
//            AssignUser buyer = new AssignUser("owner@walla.com","12345678aA","buyer","buyer");
//            Bid bid = new Bid(1, 5, 20, managers_emails, product, user);
//            bid.add_manager_answer("founder@walla.com", true, 22);
...
//            AssignUser buyer = new AssignUser("owner@walla.com","12345678aA","buyer","buyer");
//            Bid bid = new Bid(1, 5, 20, managers_emails, product, user);
//            bid.add_manager_answer("founder@walla.com", false, 22);
...
//            assertEquals(bid.get_status(), BidStatus.closed_confirm, "bid status should be waiting");
//
//            bid.add_manager_of_store("amit@gmail.com");
...
//            User user = new User();
//            Bid bid = new Bid(1, 5, 20, managers_emails, product, user);
//            bid.add_manager_of_store("owner@walla.com");
//            bid.add_manager_answer("founder@walla.com", true, -1);
//            assertEquals(bid.get_status(), BidStatus.open_waiting_for_answers, "bid status should be waiting");
