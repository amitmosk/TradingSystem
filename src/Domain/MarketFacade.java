...
public class MarketFacade implements iFacade {
    ...
    public String guest_login() {
        ...
        try
        {
            ...
            system_logger.add_log("New guest entered the system");
        }
        catch (Exception e)
        {
    ...
    public String logout() {
        Response response = null;
        if(isGuest) {
            Exception e = new Exception("Guests can not logout from the system");
            response = new Response(e);
            error_logger.add_log(e);
        }
        else {
            response = new Response(true,"Bye Bye");
...
//------------------------------------------------find product by - Start ----------------------------------------------------
    ...
    public String close_store_permanently(int store_id)
    {
        ...
        try
        {
            ...
            system_logger.add_log("Store (" + store_id + ") has been closed permanently");
    ...
    public String view_store_purchases_history(int store_id) {
        ...
        try
        {
            ...
            system_logger.add_log("User ("+ user_email + ") viewed store (" + store_id + ") purchases history");
