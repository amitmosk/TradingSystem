...
//import Acceptance.System.ExternSystems.*;
...
//        productId = entry.getKey().getProduct_id();
//        Product product = HibernateUtils.getEntityManager().find(Product.class, productId);
...
//        CartInformation cart1 = marketFacade.view_user_cart().getValue();
...
//        CartInformation cart2 = marketFacade.view_user_cart().getValue();
//        assertTrue(cart2.getProducts().size() != 0, "failed with rollback in system after buy cart failed.");
//        marketFacade.logout();
//        MarketFacade mf2 = new MarketFacade(paymentAdapter,supplyAdapter);
//        mf2.login("email123@gmail.com",password);
//        cart2 = mf2.view_user_cart().getValue();
//        assertTrue(cart2.getProducts().size() != 0, "failed with rollback in the database after buycart failed.");
